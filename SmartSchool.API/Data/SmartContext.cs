...
{
  //Aqui será criado as referencias para as tabelas do banco de dados através das classes criada na pasta Models.
  public class SmartContext : DbContext
  {
    ...
    //O Método onModelCreating será executado ao criar o banco.  O builder será o responsável para criar a relação da coluna AlunoDisiciplina, recebendo o ID do aluno e o ID da disciplina.
